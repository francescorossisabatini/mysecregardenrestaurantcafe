...
export const DailyMenuHighlight = () => {
  ...
  return (
    <section id="daily-menu" className="relative py-0 overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="relative bg-background py-12 md:py-20 px-6 md:px-12 flex flex-col justify-center">
            <BotanicalDecoration
              variant="leaf"
              className="absolute top-10 right-10 w-20 h-20 text-primary/10"
            />
            ...
            <div className="relative z-[1] max-w-xl mx-auto w-full">
              ...
              <div className="mt-8">
                <a
                  href="#food-gallery"
                  className="inline-block font-lora text-base text-primary hover:text-accent transition-colors underline decoration-2 underline-offset-4"
                >
                  {language === "de"
