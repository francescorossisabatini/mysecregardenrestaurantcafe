...
export const OrchidFlower = ({ className }: { className?: string }) => (
  <svg 
    viewBox="0 0 120 120" 
    className={className}
    fill="none" 
  ...
  >
    {/* Petali superiori */}
    <path d="M60 20 Q 50 35, 60 45 Q 70 35, 60 20" fill="currentColor" opacity="0.8" />
    <path d="M40 35 Q 45 45, 55 50 Q 50 40, 40 35" fill="currentColor" opacity="0.8" />
    <path d="M80 35 Q 75 45, 65 50 Q 70 40, 80 35" fill="currentColor" opacity="0.8" />
    
    {/* Petalo centrale grande */}
    <path d="M50 50 Q 40 70, 50 90 Q 60 85, 70 90 Q 80 70, 70 50 Z" fill="currentColor" opacity="0.7" />
    
    {/* Dettagli centrali */}
    <ellipse cx="60" cy="55" rx="8" ry="12" fill="white" opacity="0.4" />
    <circle cx="60" cy="58" r="3" fill="currentColor" opacity="0.9" />
    
    {/* Venature */}
    <path d="M60 55 Q 55 70, 50 85" stroke="currentColor" strokeWidth="0.5" opacity="0.3" />
    <path d="M60 55 Q 65 70, 70 85" stroke="currentColor" strokeWidth="0.5" opacity="0.3" />
  </svg>
);
...
export const FlowingLines = ({ className }: { className?: string }) => (
  <svg 
    viewBox="0 0 600 200" 
    className={className}
    fill="none" 
  ...
  >
    ...
    />
    <path 
      d="M0 120 Q 150 80, 300 120 T 600 120" 
      stroke="currentColor" 
      strokeWidth="2" 
      opacity="0.3"
      strokeLinecap="round"
    />
    <path 
      d="M0 80 Q 120 40, 240 80 T 600 80" 
      stroke="currentColor" 
      strokeWidth="2" 
      opacity="0.3"
      strokeLinecap="round"
