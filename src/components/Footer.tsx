    ...
    <footer className="bg-primary text-primary-foreground py-8 pb-24 md:pb-8">
      <div className="container mx-auto px-4">
        <div className="max-w-xl space-y-4">
          ...
          {/* Firma del brand: l'unico blocco centrato del footer. Il resto è
              corpo di testo (indirizzo, orari, link) e sta a sinistra come
              da regola del progetto. */}
          ...
          <Link
            to="/visit"
            className="inline-flex min-h-[44px] items-center px-3 text-sm text-primary-foreground font-work hover:underline underline-offset-2 transition-colors focus:outline-hidden focus:ring-2 focus:ring-primary-foreground/50 rounded"
          ...
          <a
            ...
            className="inline-flex min-h-[44px] items-center gap-2 px-3 font-work text-sm text-primary-foreground hover:text-primary-foreground transition-colors focus:outline-hidden focus:ring-2 focus:ring-primary-foreground/50 rounded"
