        ...
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[15rem_minmax(0,42rem)] lg:items-start lg:justify-center">
          ...
          <div ref={fixedRef} id="menu-fixed" className="scroll-mt-32">
            ...
            <div className="sticky top-[118px] z-20 -mx-4 mb-8 max-w-full border-y border-border/75 bg-nav-surface px-4 py-3 backdrop-blur-md md:top-[84px] md:mx-0 md:rounded-2xl md:border md:shadow-card">
              ...
              <div className="flex max-w-full gap-2 overflow-x-auto pb-1 md:flex-wrap md:justify-center md:overflow-visible md:pb-0 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden" aria-label={language === "de" ? "Klassiker filtern" : "Filter classics"}>
                {fixedMenuAnchors.map((anchor) => (
                  <button
                    key={anchor.id}
                    type="button"
