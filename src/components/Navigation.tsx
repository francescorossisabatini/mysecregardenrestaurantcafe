...
export const Navigation = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Drawer */}
      <div
        className={`fixed inset-0 z-[70] lg:hidden transition-all duration-[250ms] ease-out ${
          isMobileMenuOpen ? "visible" : "invisible"
        }`}
      >
        {/* Backdrop */}
        <div
          className={`absolute inset-0 bg-foreground/50 transition-opacity duration-[250ms] ease-out ${
        ...
        {/* Drawer */}
        <div
          className={`absolute left-0 top-0 h-dvh w-80 max-w-[85vw] bg-background shadow-2xl transform transition-transform duration-[300ms] ease-out flex flex-col border-r border-border/75 ${
