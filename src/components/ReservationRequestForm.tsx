...
const copy = {
  de: {
    ...
    subline: "Wähle drinnen oder draußen. Anfragen für heute sind bis 09:00 möglich.",
    ...
    success: "Anfrage erhalten. Wir melden uns bald zur Bestätigung.",
    error: "Die Anfrage konnte nicht gesendet werden. Bitte ruf uns kurz an.",
    required: "Bitte alle Pflichtfelder ausfüllen.",
    rule: "Maximal 10 Personen pro Anfrage. Same-day Reservierungen schließen um 09:00 Uhr.",
    call: "Anrufen",
  },
  en: {
    title: "Request a table",
    subline: "Choose inside or outside. Same-day requests are possible until 09:00.",
    name: "Full name",
    date: "Date",
    time: "Time",
    ...
    submit: "Send request",
    submitting: "Sending...",
    success: "Request received. We'll get back to you soon to confirm.",
    error: "We could not send the request. Please call us instead.",
    required: "Please fill in all required fields.",
    rule: "Maximum 10 people per request. Same-day reservations close at 09:00.",
    call: "Call",
  },
} as const;
