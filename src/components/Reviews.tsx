      ...
      <div className="container mx-auto px-5 max-w-4xl lg:max-w-6xl">
          ...
          {reviews.map((review, index) => (
            <div key={index} className="flex-1 text-center md:text-left lg:rounded-lg lg:border lg:border-border/70 lg:bg-card/55 lg:p-7 lg:shadow-card">
              ...
              <div>
                ...
                <p className="text-xs text-muted-high-contrast">
        ...
        <div className="text-center mt-8">
          <a
            ...
            className="inline-flex min-h-[44px] items-center gap-1.5 px-3 text-sm text-muted-high-contrast hover:text-foreground transition-colors font-work"
          >
