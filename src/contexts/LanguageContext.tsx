...
const translations = {
  de: {
    ...
    "philosophy.sri.subtitle": "Spiritueller Meister, Dichter, Künstler und Friedensbotschafter (1931 bis 2007)",
    ...
    "philosophy.sri.influence": "Diese Philosophie durchdringt jeden Winkel unseres Restaurants. Die vegetarische Küche, die meditative Atmosphäre und die Hingabe in der Zubereitung entspringen Sri Chinmoys Vision, dass Nahrung nicht nur den Körper, sondern auch die Seele nähren sollte. My Secret Garden ist unser bescheidener Versuch, seine Lehren in die Welt zu tragen.",
    ...
    "menu.soupInfo": "Unsere Tagessuppen sind vegan und werden ohne glutenhaltige Zutaten gekocht. Ein frisches Bio-Weckerl dazu: 1.90€",
    ...
    "instagram.subtitle": "Teller vom Tresen, Hofmomente und ab und zu ein Blick in die Küche",
    ...
    "contact.hours.days": "Montag bis Samstag",
  ...
  en: {
    ...
    "philosophy.sri.title": "Sri Chinmoy",
    "philosophy.sri.subtitle": "Spiritual Master, Poet, Artist and Peace Ambassador (1931 to 2007)",
    ...
    "philosophy.sri.author": "Sri Chinmoy",
    "philosophy.sri.influence": "This philosophy permeates every corner of our restaurant. The vegetarian cuisine, the meditative atmosphere and the dedication in preparation all spring from Sri Chinmoy's vision that food should nourish not only the body but also the soul. My Secret Garden is our humble attempt to carry his teachings into the world.",
    ...
    "instagram.subtitle": "Plates from the counter, courtyard moments and sometimes a look into the kitchen",
    ...
    "contact.hours.days": "Monday to Saturday",
    "contact.hours.time": "11:00 to 19:00",
    "contact.hours.closed": "Closed on holidays",
    "contact.social": "Social Media",
    "contact.social.desc": "Today’s plates and a few courtyard moments",
