...
const translations = {
  de: {
    ...
    "philosophy.intro": "Es liegt uns am Herzen, dass die Welt zu einem besseren und schöneren Ort wird. Wir wollen mit unserer Arbeit, unserem Lebensstil und unserem Bewusstsein dazu beitragen.",
    "philosophy.meditation": "Das Team und die Atmosphäre in unserem Restaurant sind von der Philosophie und dem Meditationsweg",
    "philosophy.inspired": "inspiriert.",
    "philosophy.harmony": "Wir nutzen Meditation um Harmonie und Bewusst-Sein in unsere Aktivitäten zu bringen. Familiäre Atmosphäre und Herzlichkeit wird großgeschrieben und unser spiritueller Background sorgt für das Plus an Lebensfreude.",
    ...
    "philosophy.feature3.title": "Gemeinschaft",
  ...
  en: {
    ...
    "philosophy.intro": "It is close to our hearts that the world becomes a better and more beautiful place. We want to contribute to this with our work, our lifestyle and our consciousness.",
    "philosophy.meditation": "The team and atmosphere in our restaurant are inspired by the philosophy and meditation path of",
    "philosophy.inspired": "",
    "philosophy.harmony": "We use meditation to bring harmony and consciousness into our activities. Family atmosphere and warmth are highly valued, and our spiritual background provides that extra joy of life.",
    ...
    "philosophy.feature3.title": "Community",
