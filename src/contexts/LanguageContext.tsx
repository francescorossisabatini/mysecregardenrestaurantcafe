...
const translations = {
  de: {
    ...
    "philosophy.sri.title": "Die Inspiration: Sri Chinmoy",
    "philosophy.sri.subtitle": "Das Herz und die Seele unseres Restaurants",
    "philosophy.sri.story": "My Secret Garden wurde aus der tiefen Inspiration und den Lehren von Sri Chinmoy geboren, einem spirituellen Lehrer, Dichter und Friedensbotschafter. Seine Philosophie der Selbstverbesserung, des inneren Friedens und der Harmonie mit der Natur bildet das Fundament unseres Restaurants. Jeder Aspekt unseres Ortes – von der liebevollen Zubereitung der Speisen bis zur friedvollen Atmosphäre – spiegelt seine Weisheit wider.",
    ...
    "philosophy.sri.influence": "Diese Worte leiten uns täglich. Wir glauben daran, dass wahre Veränderung von innen kommt – durch Meditation, bewusste Ernährung und liebevolle Gemeinschaft. My Secret Garden ist mehr als ein Restaurant: Es ist ein Ort, an dem Sri Chinmoys Vision eines harmonischen, friedvollen Lebens lebendig wird.",
  ...
  en: {
    ...
    "philosophy.sri.title": "The Inspiration: Sri Chinmoy",
    "philosophy.sri.subtitle": "The Heart and Soul of Our Restaurant",
    "philosophy.sri.story": "My Secret Garden was born from the deep inspiration and teachings of Sri Chinmoy, a spiritual teacher, poet, and peace ambassador. His philosophy of self-improvement, inner peace, and harmony with nature forms the foundation of our restaurant. Every aspect of our place – from the loving preparation of meals to the peaceful atmosphere – reflects his wisdom.",
    ...
    "philosophy.sri.author": "Sri Chinmoy",
    "philosophy.sri.influence": "These words guide us daily. We believe that true change comes from within – through meditation, conscious eating, and loving community. My Secret Garden is more than a restaurant: it is a place where Sri Chinmoy's vision of a harmonious, peaceful life comes alive.",
