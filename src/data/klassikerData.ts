      ...
      subcategories: [
        {
          ...
          items: [
            ...
            { id: "glueh-kombucha", name: { de: "\"Glüh\" Kombucha", en: "\"Glüh\" Kombucha (hot)" }, price: "4,90" },
            ...
            { id: "verlaengerter", name: { de: "Verlängerter / Americano", en: "Verlängerter / Americano" }, sizeNote: "kurz / lang · short / long", price: "3,50 / 4,50" },
        ...
        },
        {
          ...
          items: [
            { id: "strawberry-spritz", name: { de: "Strawberry Spritz", en: "Strawberry Spritz" }, sizeNote: "Erdbeer-Tonic & Soda · strawberry tonic & soda", price: "6,50", isNew: true },
        ...
        },
        {
          ...
          items: [
            ...
            { id: "green-tea-soda", name: { de: "Grüner Tee", en: "Green Tea" }, price: "3,90" },
          ],
        },
        {
          id: "more-cold-drinks",
          ...
          items: [
            { id: "goesser-beer", name: { de: "Gösser Alkoholfrei", en: "Gösser Non-Alcoholic Beer" }, sizeNote: "0,5 l", price: "4,50" },
