...
/**
 * Link-in-bio landing page for Instagram traffic.
 * Mobile-first, 4 large buttons, minimal design.
 */
const LinkPage = () => {
  ...
  const links = [
    ...
    {
      href: SITE.mapsUrl,
      label: { de: "Wegbeschreibung", en: "Directions" },
      icon: MapPin,
      isExternal: true,
    },
    {
      href: `tel:${SITE.phoneTel}`,
      label: { de: "Anrufen", en: "Call Us" },
      icon: Phone,
      isExternal: false,
      isTel: true,
    },
  ...
  return (
    <div className="min-h-[100dvh] bg-background flex flex-col items-center justify-center px-4 py-8">
      {/* Header */}
      ...
      <div className="w-full max-w-sm space-y-3">
        {links.map((link) => {
          ...
          const content = (
            <span className="flex items-center justify-center gap-3 w-full py-4 px-6 
              bg-primary text-primary-foreground 
              rounded-xl text-lg font-medium font-work
