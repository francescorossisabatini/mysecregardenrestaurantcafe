...
const StaffKitchen = () => {
  ...
  if (!isCheckingAccess && session && !isStaff) {
    return (
      <div className="staff-app notranslate min-h-screen bg-background px-4 py-12 font-work text-foreground" translate="no" lang="en">
        <SEOHead title="Staff Kitchen" description="Restricted internal staff area for My Secret Garden Wien kitchen operations and daily Küchenplan." path="/staff" noindex notranslate />
  ...
  return (
    <div className="staff-app notranslate min-h-screen bg-background font-work text-foreground" translate="no" lang="en">
      <SEOHead title="Staff Kitchen" description="Internal Küchenplan dashboard for My Secret Garden Wien kitchen staff: daily dishes, ingredients and prep notes." path="/staff" noindex notranslate />
